...
function adjustContrast(contrast, blackpoint, recovery) {
  if (!is.defined(contrast)) {
    this.options.contrast = 0.0;
  } else {
    this.options.contrast = contrast;
  }

  if (!is.defined(blackpoint)) {
    this.options.blackpoint = 0.0;
  } else {
    this.options.blackpoint = blackpoint;
  }

  if (!is.defined(recovery)) {
    this.options.recovery = 0.0;
  } else {
...
function adjustTemperature(temperature) {
  if (!is.defined(temperature))
  {
    this.options.temperature = 0.0;
  } else {
...
function adjustTones(shadows, highlights, midtones)
{
  if (!is.defined(shadows)) {
    this.options.shadows = 0.0;
  } else {
    this.options.shadows = shadows;
  }

  if (!is.defined(highlights)) {
    this.options.highlights = 0.0;
  } else {
    this.options.highlights = highlights;
  }

  if (!is.defined(midtones))
  {
    this.options.midtones = 0.0;
  } else {
    this.options.midtones = midtones;
  }
...
function plotHistogram() {
  this.options.plotHistogram = true;
  return this;
}
/**
